...
//    <div
//      onSubmit={handleSubmit}
//      className="bg-gray-100 shadow-md rounded-lg w-full md:w-3/4 p-6"
//    >
//      <div>
//        <h3 className="text-gray-700 uppercase font-bold text-xl mb-4">
//          Pacientes Agregados
//        </h3>
//        <ul>
...
//                Nombre Mascota: {paciente.nombreMascota}
//              </p>
//              <p className="text-black font-bold">
//                Nombre Propietario: {paciente.nombrePropietario}
//              </p>
